...
# Config Log
file_path_log =  'Sistemas/Tribanco/TransacoesPF/Log/' #Nao alterar
...
prefix_name='exports-bi-tribanco/'
# credenciais
aws_access_key_id=''
...
file_path_downloads = 'Sistemas/Tribanco/TransacoesPF/'  #Nao alterar
